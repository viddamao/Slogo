...
public class TurtleList {
 ...
 /**
	 * get a turtle from the list of turtles that is created by the index specified
	 * @param index
	...
	/**
	 * locate in the list of all the turtles created to get the turtles indicated by the list of
	 * indexes that needed to be added to the active list of turtles
	 * @param indexes
	 * @return boolean
	 */
	...
	/**
	 * get the index of a turtle in the list of all the turtles created when providing the turtle 
	 * @param turtle
	 * @return index
	 */
...
/**
 * creates the turtle and added it to a list of turtles that has been created
